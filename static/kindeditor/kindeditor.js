        ...
        init: function(b) {
            ...
            var e = {
                ...
                upload_success_handler: function(b, e) {
                    ...
                    return 1 !== d.code ? void c(f, a.DEBUG ? g.msg: d.options.errorMessage) : (b.url = g.url, a(".ke-img", f).attr("src", b.url).attr("data-status", b.filestatus).data("data", g), void a(".ke-status > div", f).hide())
                }
            };
...
function() {
    ...
    SWFUpload.prototype.debugMessage = function(a) {
        if (this.settings.debug) {
            var b, c = [];
            if ("object" == typeof a && "string" == typeof a.name && "string" == typeof a.msg) {
    ...
    SWFUpload.Console.writeLine = function(a) {
        ...
        try {
            ...
            alert("Exception: " + d.name + " Message: " + d.msg)
        }
    }
} (),
function() {
